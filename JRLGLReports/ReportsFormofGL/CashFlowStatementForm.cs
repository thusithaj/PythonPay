...
namespace ReportsFormofGL
{
    public partial class CashFlowStatementForm : Form
    {
        ...
        public CashFlowStatementForm(string comcode, string comname)
        {
            InitializeComponent();
            CompanyCode = comcode;
            ComName = comname;
        ...
        private void bPrint_Click(object sender, EventArgs e)
        {
            ...
            cmd.Parameters.Add(new SqlParameter("@Company", SqlDbType.NVarChar)).Value = CompanyCode;
        ...
        private void SetRportParameters()
        {
            switch (ReportName)    
            {
                case "CashFlow.rpt":
                    ...
                    report.SetParameterValue("@Company", CompanyCode);
                    report.SetParameterValue("CompanyName", ComName);
