...
namespace ReportsFormofGL
{
    public partial class BalanceSheetForm : Form
    {
        ...
        private void LoadReports()
        {
            ...
            dtrpt.Rows[0][0] = "Balance Sheet";
            dtrpt.Rows[0][1] = "BalanceSheet.rpt";
            dtrpt.Rows.Add(dtrpt.NewRow());
            dtrpt.Rows[1][0] = "Comparison Balance Sheet";
            dtrpt.Rows[1][1] = "BalanceSheetComparison.rpt";
        ...
        private void bPrint_Click(object sender, EventArgs e)
        {
            ...
            report.SetParameterValue(PREBAL, "N");
            report.SetParameterValue(REPTYPE, "B");
            report.SetParameterValue(PREYEAR, dtPrePeriod.Value.Year);
            report.SetParameterValue(PREPERIOD, dtPrePeriod.Value.Month -2);
            report.SetParameterValue("PreviouseYear", dtPrePeriod.Value.Year);
            report.SetParameterValue("PreviousePeriod", dtPrePeriod.Value.Month - 2);
            report.SetParameterValue("CurrentYear", dtPeriod.Value.Year);
            report.SetParameterValue("CurrentPeriod", dtPeriod.Value.Month - 2);
            ...
            string sql = "BalanceSheetData @finyear, @finperiod, @Company, @zeroFlag, @PreBalace, @ReportType,@PreYear, @PrePeriod";
            cmd.CommandText = sql;
            ...
            cmd.Parameters.Add(new SqlParameter(PREBAL, SqlDbType.NVarChar)).Value = "N";
            cmd.Parameters.Add(new SqlParameter(REPTYPE, SqlDbType.NVarChar)).Value = "B";
            cmd.Parameters.Add(new SqlParameter(PREYEAR, SqlDbType.Int)).Value = dtPrePeriod.Value.Year;
            cmd.Parameters.Add(new SqlParameter(PREPERIOD, SqlDbType.Int)).Value = dtPrePeriod.Value.Month - 2;
